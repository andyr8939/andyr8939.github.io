...
To deploy it create a yaml file using whatever editor you use (its VSCode right?) with the below.  You can also find all these files in my GitHub repo.
...
And apply the ingressrotue manifest.
